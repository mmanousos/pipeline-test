...
# avro = AvroTurf::Messaging.new(registry_url: "http://localhost:8081", schemas_path:"producer/src/schemas/")
...
# happens the first time a schema is used with the instance of `AvroTurf`.
  # data = avro.encode(msg, schema_name: "numbers")

  producer.produce(msg, topic: "number") # `.produce` is a method from the ruby-kafka library
